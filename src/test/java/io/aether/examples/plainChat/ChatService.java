...
public class ChatService {
	...
	public ChatService() {
		...
		aether.onClientStream((s)->{
			var apiNode = ApiNode.of(ServiceServerApi.META, ServiceClientApi.META, s.up());
			clients.put(s.getConsumerUUID(),apiNode.forClient(new MyServiceServerApi(s.getConsumerUUID())));
		});
	}
