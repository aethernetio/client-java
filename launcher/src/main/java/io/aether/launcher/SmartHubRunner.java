...
public class SmartHubRunner extends AbstractProjectRunner {
    ...
    boolean serviceRunning() {
        return serviceProcess != null && serviceProcess.isAlive();
    }
    ...
    String getServiceUuid() {
        return detectedServiceUuid.get();
    }
    ...
    public String getRepoUrl() {
        return "https://github.com/aethernetio/client-java.git";
    }
    ...
    public String getServiceMainClass() {
        return "SmartHubService";
    }

    @Override
    public String getEmulatorMainClass() {
        return "SmartDeviceEmulator";
    }

    @Override
    public String getServiceSourcePath() {
        return "smarthub/src/main/java/io/aether/smarthub/SmartHubService.java";
    }

    @Override
    public String getEmulatorSourcePath() {
        return "smarthub/src/main/java/io/aether/smarthub/SmartDeviceEmulator.java";
    }
    ...
    @Override
    public void handleClone(HttpExchange t) throws IOException {
    ...
    @Override
    public void handleBuild(HttpExchange t) throws IOException {
    ...
    @Override
    public void handleRun(HttpExchange t) throws IOException {
        if (Launcher.jdkHome == null || Launcher.gradleHome == null) {
            Launcher.ensureTools();
            Launcher.sendOk(t, "{\"status\":\"waiting_for_tools\"}");
            return;
    ...
    @Override
    public void handleStop(HttpExchange t) throws IOException {
        stopService();
        Launcher.sendOk(t, "{\"status\":\"stopped\"}");
    }

    @Override
    public void handleRunEmulator(HttpExchange t) throws IOException {
    ...
    @Override
    public void handleStopEmulator(HttpExchange t) throws IOException {
        stopEmulator();
        Launcher.sendOk(t, "{\"status\":\"stopped\"}");
    }
